function initengahan(){
  ...
  if(waktuSekarang < 10){ucapan = "selamat pagi sayang, ";} 
  else if(waktuSekarang < 16){ucapan = "selamat siang sayang, ";}
  else if(waktuSekarang < 19){ucapan = "selamat sore sayang, ";}
  else{ucapan = "selamat malam sayang, ";}
